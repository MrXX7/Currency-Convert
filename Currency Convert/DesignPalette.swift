...
enum DesignPalette {
    ...
    static let mutedInk = Color(red: 0.28, green: 0.43, blue: 0.58)
    static let surface = Color(red: 0.96, green: 0.99, blue: 1.00)
    static let elevatedSurface = Color(red: 0.90, green: 0.96, blue: 0.99)
    static let elevatedSurfaceStrong = Color(red: 0.88, green: 0.95, blue: 0.99)
    static let stroke = Color(red: 0.69, green: 0.83, blue: 0.93)
    ...
    static let shadow = Color(red: 0.20, green: 0.44, blue: 0.68).opacity(0.12)
